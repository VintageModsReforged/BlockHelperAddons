...
public class TooltipData {
    ...
    public TooltipData(String[] strings) {
        ...
        this.fluidId = strings[6];
    }

    public TooltipData(int current, int max, int color, String text, boolean isStringOnly, boolean centered, String fluidId) {
    ...
    public static TooltipData fluid(int current, int max, String text, String fluidId) {
